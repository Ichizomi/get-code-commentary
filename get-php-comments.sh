...
# 2) - run this script via terminal and send the file name.php as first argument, send the desired
...
truename=$(echo ${inputfile} | grep -o "[^\/]*\.php") # Grab true file name without path
